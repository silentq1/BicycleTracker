...
import ru.gzaytsev.bicycletracker.presentation.settingsFragment.placeholder.PlaceholderContent
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = settingsRecyclerViewAdapter(PlaceholderContent.ITEMS)
            }
        }
        return view
    }
